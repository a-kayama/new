...
<html lang="ja">
  ...
  <body>
    ...
    <img id="tro_logo" src="php.Original/image/2-sei-logo.jpg" alt="２歳児製作ロゴ">
    ...
    <?php foreach ($result as $row): ?>
      ...
      <table id="idea-2">
       ...
       <tr><th>対象年齢</th></tr>
       <tr><td class="ct"><?php  if($row['age_id'] =="2") { echo "2歳児" ;}?></td></tr>
       <tr><th>カテゴリー</th></tr>
       <tr><td class="ct"><?php  if($row['category_id'] =="2") { echo "製作" ;}?></td></tr>
       <tr><th>写真</th></tr>
